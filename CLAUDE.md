...
`/conformance/` -- the conformance checking repository designed to validate if clients and server SDKs meet all specification requirements
`/mcpjam-inspector/` -- a fork of the inspector that has really good testing infrastructure and uses a client proxy method to connect the servers. 
